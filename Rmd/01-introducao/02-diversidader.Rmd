...
Vamos adicionar ao final da tabela `pe` três colunas, uma com a riqueza de espécies ($S$), uma com o índice de diversidade de Simpson ($D$) e outra com a equabilidade de Simpson ($E$). Desta forma teremos as três medidas de diversidade relevantes.
